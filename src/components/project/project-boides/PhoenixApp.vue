...
<template>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="flex flex-col justify-center gap-5">
            ...
            <p>After learning the stack of the main app "Always Here" I
                ...
                <br>
                <br>
                Although daunting at first to be working on two project at the same time I was
                excited.
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="order-2 md:order-1 flex flex-col justify-center gap-5">
            ...
            <p>Once again still being new to the whole workforce and programming thing, I committed myself to
                ...
                forth between the documentation for each css class which I already knew. However that
                this
                would speed up my development time substantially in the future.
            </p>
        </div>

        <video class="h-auto order-1 md:order-2" loop autoplay>
            <source src="@/assets/ProjectImages/Phoenix/section-2.mp4" type="video/mp4">
        </video>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <video loop autoplay>
            <source src="@/assets/ProjectImages/Phoenix/section-1.mp4" type="video/mp4">
        </video>
        ...
        <div class="flex flex-col justify-center gap-5">
            ...
            <p>My time working on Phoenix was a good one, learning to enjoy the creation process and joys of Tailwind.
                ...
                the drag and drop interactions of the tool. Having at
