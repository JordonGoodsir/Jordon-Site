...
<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <img src="@/assets/ProjectImages/SimConverse/site-map.svg" alt="SimConverse's site map"
            class="h-auto order-1 md:order-2" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="flex flex-col justify-center gap-5">
            ...
            <p> I learned that I should always be trying to improve the code I write, by exploring different tools,
                ideologies and through revisiting fundamentals of programming. This being because there are always
                updated/new useful tools released, for example in Vue 3.4 came "Define Model", a useful macro which can
                save countless lines of code making it readable.
            </p>
        </div>
    </div>
</template>
